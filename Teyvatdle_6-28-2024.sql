...
-- Started on 2024-06-28 23:31:15 PDT
...
SELECT pg_catalog.setval('genshin.boss_drops_id_seq', 63, true);
...
SELECT pg_catalog.setval('genshin.bosses_id_seq', 41, true);
...
SELECT pg_catalog.setval('genshin.character_id_seq', 94, true);
...
SELECT pg_catalog.setval('genshin.constellation_id_seq', 540, true);
...
SELECT pg_catalog.setval('genshin.daily_record_id_seq', 340, true);
...
SELECT pg_catalog.setval('genshin.enemy_drops_id_seq', 87, true);
...
SELECT pg_catalog.setval('genshin.enemy_families_id_seq', 41, true);
...
SELECT pg_catalog.setval('genshin.food_id_seq', 354, true);
...
SELECT pg_catalog.setval('genshin.talent_id_seq', 526, true);
...
SELECT pg_catalog.setval('genshin.weapon_id_seq', 203, true);
...
-- Completed on 2024-06-28 23:31:18 PDT
